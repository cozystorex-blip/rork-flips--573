...
const s = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 11, fontWeight: '700' as const, color: Colors.textTertiary, letterSpacing: 1, marginBottom: 8, marginTop: 4 },
  servingText: { fontSize: 12, color: Colors.textTertiary, fontWeight: '500' as const, marginBottom: 12 },
  calRow: { flexDirection: 'row', alignItems: 'baseline', gap: 6, justifyContent: 'center', marginBottom: 16 },
  calValue: { fontSize: 38, fontWeight: '800' as const, color: Colors.text, letterSpacing: -1 },
  calLabel: { fontSize: 16, fontWeight: '600' as const, color: Colors.textSecondary },
  macroRow: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: 14, backgroundColor: Colors.cardMuted, borderRadius: 12, paddingVertical: 14, paddingHorizontal: 8 },
  macroItem: { alignItems: 'center', gap: 4 },
  macroDot: { width: 8, height: 8, borderRadius: 4 },
  macroVal: { fontSize: 16, fontWeight: '800' as const, color: Colors.text },
  macroLabel: { fontSize: 11, fontWeight: '500' as const, color: Colors.textSecondary },
  extraRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 12, paddingHorizontal: 4 },
  extraText: { fontSize: 13, color: Colors.textSecondary, fontWeight: '500' as const },
  summaryCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#F0FDF4', borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#BBF7D0' },
  summaryText: { fontSize: 13, color: '#166534', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 14 },
  nutrientChip: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#1B5E3B0D', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  nutrientChipText: { fontSize: 12, fontWeight: '600' as const, color: Colors.accent },
  benefitRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, marginBottom: 8, paddingLeft: 2 },
  benefitText: { fontSize: 13, color: Colors.text, flex: 1, lineHeight: 18, fontWeight: '500' as const },
  tipCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#EFF6FF', borderRadius: 10, padding: 12, marginTop: 10, borderWidth: 1, borderColor: '#BFDBFE' },
  tipText: { fontSize: 13, color: '#1E40AF', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  tagsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 12 },
  tagPill: { backgroundColor: '#1B5E3B10', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  tagPillText: { fontSize: 11, fontWeight: '600' as const, color: Colors.accent, textTransform: 'capitalize' as const },
  detailRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10 },
  detailLabel: { fontSize: 13, color: Colors.textSecondary, fontWeight: '500' as const, width: 60 },
  detailValue: { fontSize: 14, color: Colors.text, fontWeight: '600' as const, flex: 1 },
  priceCard: { backgroundColor: Colors.cardMuted, borderRadius: 12, padding: 14, gap: 8, marginBottom: 12 },
  priceRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  priceLabel: { fontSize: 13, color: Colors.textSecondary, fontWeight: '500' as const, flex: 1 },
  priceValue: { fontSize: 15, color: Colors.text, fontWeight: '700' as const },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 12 },
  ratingText: { fontSize: 14, color: Colors.text, fontWeight: '500' as const },
  ratingBold: { fontWeight: '700' as const },
  insightCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#EFF6FF', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 8, borderWidth: 1, borderColor: '#BFDBFE' },
  insightText: { fontSize: 13, color: '#1E40AF', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  alternativeCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#ECFDF5', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 8, borderWidth: 1, borderColor: '#A7F3D0' },
  alternativeText: { fontSize: 13, color: '#065F46', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  furnitureGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 14 },
  furnitureCell: { flexBasis: '47%' as unknown as number, flexGrow: 0, flexShrink: 0, backgroundColor: Colors.cardMuted, borderRadius: 10, padding: 12 },
  furnitureCellLabel: { fontSize: 11, fontWeight: '600' as const, color: Colors.textTertiary, letterSpacing: 0.5, marginBottom: 4 },
  furnitureCellValue: { fontSize: 14, fontWeight: '600' as const, color: Colors.text },
  fashionGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 14 },
  fashionCell: { flexBasis: '47%' as unknown as number, flexGrow: 0, flexShrink: 0, backgroundColor: Colors.cardMuted, borderRadius: 10, padding: 12 },
  fashionCellLabel: { fontSize: 11, fontWeight: '600' as const, color: Colors.textTertiary, letterSpacing: 0.5, marginBottom: 4 },
  fashionCellValue: { fontSize: 14, fontWeight: '600' as const, color: Colors.text },
  fashionDescCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FFF1F2', borderRadius: 10, padding: 12, marginBottom: 14, borderWidth: 1, borderColor: '#FECDD3' },
  fashionDescText: { fontSize: 14, color: '#9F1239', flex: 1, lineHeight: 20, fontWeight: '600' as const },
  fashionTagPill: { backgroundColor: '#FFF1F2', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  fashionTagPillText: { fontSize: 11, fontWeight: '600' as const, color: '#E11D48', textTransform: 'capitalize' as const },
  shoeIdHero: { alignItems: 'center', marginBottom: 16, paddingTop: 4 },
  shoeIdModelName: { fontSize: 22, fontWeight: '800' as const, color: '#1A1A1A', letterSpacing: -0.5, textAlign: 'center' as const, lineHeight: 28 },
  ...
  comparableCard: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#FFF1F2', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#FECDD3' },
  comparableContent: { flex: 1 },
  comparableTitle: { fontSize: 11, fontWeight: '600' as const, color: '#9F1239', letterSpacing: 0.3, marginBottom: 2 },
  comparableModel: { fontSize: 15, fontWeight: '700' as const, color: '#881337' },
  resaleCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#ECFDF5', borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#A7F3D0' },
  resaleText: { fontSize: 13, color: '#065F46', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  electronicsDescCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#F0F9FF', borderRadius: 10, padding: 12, marginBottom: 14, borderWidth: 1, borderColor: '#BAE6FD' },
  electronicsDescText: { fontSize: 14, color: '#0C4A6E', flex: 1, lineHeight: 20, fontWeight: '600' as const },
  electronicsTagPill: { backgroundColor: '#F0F9FF', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  electronicsTagPillText: { fontSize: 11, fontWeight: '600' as const, color: '#0284C7', textTransform: 'capitalize' as const },
  depreciationCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FEF2F2', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 8, borderWidth: 1, borderColor: '#FECACA' },
  depreciationText: { fontSize: 13, color: '#991B1B', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  householdDescCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#F5F3FF', borderRadius: 10, padding: 12, marginBottom: 14, borderWidth: 1, borderColor: '#DDD6FE' },
  householdDescText: { fontSize: 14, color: '#5B21B6', flex: 1, lineHeight: 20, fontWeight: '600' as const },
  householdRecommendCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#F5F3FF', borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#DDD6FE' },
  householdRecommendText: { fontSize: 13, color: '#5B21B6', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  householdNoteCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FFFBEB', borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#FDE68A' },
  householdNoteText: { fontSize: 13, color: '#92400E', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  householdPickupCard: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#ECFDF5', borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#A7F3D0' },
  householdPickupText: { fontSize: 13, color: '#065F46', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  householdTagPill: { backgroundColor: '#F5F3FF', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  householdTagPillText: { fontSize: 11, fontWeight: '600' as const, color: '#7C3AED', textTransform: 'capitalize' as const },
  clothingConditionCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FFFBEB', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 8, borderWidth: 1, borderColor: '#FDE68A' },
  clothingConditionText: { fontSize: 13, color: '#92400E', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  clothingCleaningCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#F0F9FF', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 8, borderWidth: 1, borderColor: '#BAE6FD' },
  clothingCleaningText: { fontSize: 13, color: '#0C4A6E', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  whatElseWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 12 },
  whatElseChip: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#F5F3FF', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: '#DDD6FE' },
  whatElseChipText: { fontSize: 12, fontWeight: '600' as const, color: '#5B21B6' },
  totalCostCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FFFBEB', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 8, borderWidth: 1, borderColor: '#FDE68A' },
  totalCostText: { fontSize: 13, color: '#92400E', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  unknownCard: { alignItems: 'center', paddingVertical: 24, gap: 8 },
  unknownTitle: { fontSize: 16, fontWeight: '600' as const, color: Colors.text },
  unknownSub: { fontSize: 13, color: Colors.textSecondary, textAlign: 'center' as const, lineHeight: 18 },
  ikeaToolsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 4 },
  ikeaToolItem: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#E8F4FD', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: '#B3D9F2' },
  ikeaToolIconWrap: { width: 28, height: 28, borderRadius: 8, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center' },
  ikeaToolName: { fontSize: 13, fontWeight: '600' as const, color: '#004F93' },
  ikeaValueCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#E8F4FD', borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#B3D9F2' },
  ikeaValueText: { fontSize: 13, color: '#004F93', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  ikeaSetupCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#E8F4FD', borderRadius: 10, padding: 12, marginTop: 8, marginBottom: 4, borderWidth: 1, borderColor: '#B3D9F2' },
  ikeaSetupText: { fontSize: 13, color: '#004F93', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  ikeaAnchorCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FEF2F2', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 4, borderWidth: 1, borderColor: '#FECACA' },
  ikeaAnchorText: { fontSize: 13, color: '#991B1B', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  ikeaMatchGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 8 },
  ikeaMatchItem: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#E8F4FD', paddingHorizontal: 10, paddingVertical: 7, borderRadius: 8, borderWidth: 1, borderColor: '#B3D9F2' },
  ikeaMatchText: { fontSize: 12, fontWeight: '600' as const, color: '#004F93' },
  ikeaRoomLabels: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 8 },
  ikeaRoomPill: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#FFF8E1', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: '#FFE082' },
  ikeaRoomPillText: { fontSize: 12, fontWeight: '600' as const, color: '#E65100', textTransform: 'capitalize' as const },
  ikeaTagPill: { backgroundColor: '#E8F4FD', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  ikeaTagPillText: { fontSize: 11, fontWeight: '600' as const, color: '#0058A3', textTransform: 'capitalize' as const },
  assemblyDisclaimer: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 10 },
  assemblyDisclaimerText: { fontSize: 11, color: '#D97706', fontWeight: '500' as const },
  assemblyCard: { backgroundColor: Colors.cardMuted, borderRadius: 12, padding: 14, gap: 10, marginBottom: 12 },
  assemblyRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  assemblyLabel: { fontSize: 13, color: Colors.textSecondary, fontWeight: '500' as const, flex: 1 },
  assemblyValue: { fontSize: 14, color: Colors.text, fontWeight: '600' as const },
  ...
  partChip: { backgroundColor: '#F3F4F6', paddingHorizontal: 9, paddingVertical: 4, borderRadius: 7, borderWidth: 1, borderColor: '#E5E7EB' },
  partChipText: { fontSize: 11, fontWeight: '500' as const, color: '#374151' },
  noAssemblyCard: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F0FDF4', borderRadius: 12, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#BBF7D0' },
  noAssemblyText: { fontSize: 14, fontWeight: '600' as const, color: '#166534' },
  assemblySummaryCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FFFBEB', borderRadius: 10, padding: 12, marginTop: 10, borderWidth: 1, borderColor: '#FDE68A' },
  assemblySummaryText: { fontSize: 13, color: '#92400E', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  similarCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: Colors.cardMuted, borderRadius: 10, padding: 12, marginTop: 8 },
  similarText: { fontSize: 13, color: Colors.textSecondary, flex: 1, lineHeight: 18, fontWeight: '500' as const },
  extraPurchaseList: { gap: 8, marginBottom: 12 },
  extraPurchaseRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  extraPurchaseDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#D97706', marginTop: 6 },
  ...
  extraPurchaseName: { fontSize: 14, fontWeight: '600' as const, color: Colors.text },
  extraPurchaseCost: { fontSize: 13, fontWeight: '700' as const, color: '#D97706' },
  extraPurchaseReason: { fontSize: 12, color: Colors.textSecondary, lineHeight: 16 },
  noExtraCard: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F0FDF4', borderRadius: 10, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: '#BBF7D0' },
  noExtraText: { fontSize: 13, fontWeight: '600' as const, color: '#166534' },
  ...
  verdictTextCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#ECFDF5', borderRadius: 10, padding: 12, marginTop: 4, marginBottom: 8, borderWidth: 1, borderColor: '#A7F3D0' },
  verdictTextValue: { fontSize: 13, color: '#065F46', flex: 1, lineHeight: 18, fontWeight: '600' as const },
  generalDescCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#F0FDFA', borderRadius: 10, padding: 12, marginBottom: 14, borderWidth: 1, borderColor: '#99F6E4' },
  generalDescText: { fontSize: 14, color: '#134E4A', flex: 1, lineHeight: 20, fontWeight: '600' as const },
  ...
  generalFunFactCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#FFFBEB', borderRadius: 10, padding: 12, borderWidth: 1, borderColor: '#FDE68A' },
  generalFunFactText: { fontSize: 13, color: '#92400E', flex: 1, lineHeight: 18, fontWeight: '500' as const },
  generalTagPill: { backgroundColor: '#F0FDFA', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  generalTagPillText: { fontSize: 11, fontWeight: '600' as const, color: '#0D9488', textTransform: 'capitalize' as const },
  resellCard: { backgroundColor: '#F0FDF4', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: '#A7F3D0', gap: 12 },
  resellValueRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  resellValueContent: { flex: 1 },
  resellValueLabel: { fontSize: 12, fontWeight: '600' as const, color: '#059669', letterSpacing: 0.3 },
  resellValueAmount: { fontSize: 22, fontWeight: '800' as const, color: '#065F46', letterSpacing: -0.5 },
  resellMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingLeft: 30 },
  resellMetaText: { fontSize: 13, color: '#6B7280', fontWeight: '500' as const },
  resellMetaBold: { fontWeight: '700' as const, color: '#374151' },
  resellTipRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 6, paddingLeft: 30, paddingTop: 4, borderTopWidth: 1, borderTopColor: '#D1FAE5' },
  resellTipText: { fontSize: 12, color: '#92400E', flex: 1, lineHeight: 17, fontWeight: '500' as const },
  resellNaCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#F3F4F6', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#E5E7EB' },
  resellNaContent: { flex: 1 },
  resellNaTitle: { fontSize: 14, fontWeight: '600' as const, color: '#6B7280' },
  resellNaDesc: { fontSize: 12, color: '#9CA3AF', marginTop: 2, fontWeight: '500' as const },
  goesWithGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 4 },
  goesWithChip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#F5F3FF', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, borderWidth: 1, borderColor: '#DDD6FE' },
  goesWithText: { fontSize: 13, fontWeight: '600' as const, color: '#5B21B6' },
});
