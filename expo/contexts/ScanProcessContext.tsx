  ...
  const handleCapture = useCallback(async (mode: 'camera' | 'gallery', ikeaScanMode?: IkeaScanMode) => {
    ...
    try {
      ...
      const fallbackResult: SmartScanResult = {
        ...
        general_details: {
          item_description: 'Item detected but could not be fully analyzed. The result below is a best-effort estimate based on visual similarity.',
          subcategory: 'other',
          brand: null, model: null, material: null, color: null, condition: null,
          estimated_retail_price: '$5 - $50',
          estimated_resale_value: '$2',
          price_range: '$2 - $25',
          value_rating: 'average',
          value_verdict: 'fair',
          value_reasoning: 'Estimated from general category. Try scanning with better lighting or a clearer angle for more accurate pricing.',
          resale_demand: 'low',
          resale_suggestion: 'Take a clearer photo showing any labels, brand marks, or distinguishing features for better resale analysis.',
          ...
          tags: ['rescan-recommended', 'general'],
          complementary_items: ['Related accessories', 'Replacement parts'],
          purpose: 'Item detected — rescan with better lighting for full analysis.',
        ...
        is_receipt: false,
        short_summary: 'Item detected but details are limited. Try a clearer photo for full resale analysis.',
        image_description: '',
      };
